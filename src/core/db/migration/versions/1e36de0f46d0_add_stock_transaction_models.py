...
def upgrade() -> None:
    ...
    op.create_table('bond_transaction',
    sa.Column('bond_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('quantity', sa.Float(), nullable=False),
    sa.Column('operation', sa.Enum('BUY', 'SELL', name='operationenum'), nullable=False),
    ...
    op.create_table('etf_transaction',
    ...
    op.create_table('future_transaction',
    ...
    op.create_table('share_transaction',
