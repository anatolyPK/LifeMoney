...
class AssetSearchManager:
    def __init__(self, model: Type[Base], session: AsyncSession, dto_schema: Type[BaseModel]):
        self._model = model
    ...
    async def search_asset(
        ...
        async with self._session() as session:
            ...
            result_dto = [self._dto_schema.model_validate(asset) for asset in result_orm]
